...
def generate_launch_description():
        ...
        # Adding boundary wire
        boundary_wire = Node(
                package='lawn_robot_project',  # Replace with your package name
                executable='boundaries.py',  # Replace with your Python script name (without the .py extension)
                name='boundaries',
                output='screen',
        )
        ...
        path_tracking = Node(
                package='lawn_robot_project',  # Replace with your package name
                executable='path_tracking.py',  # Replace with your Python script name (without the .py extension)
                name='path_tracking',
                output='screen',
        )
        ...
        launchDescriptionObject.add_action(boundary_wire)
        launchDescriptionObject.add_action(path_tracking)
